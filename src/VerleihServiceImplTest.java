...
public class VerleihServiceImplTest
{
    ...
    private Verleihkarte _verleihkarte;
    ...
    @Test
    public void testHinzufuegenVonVerleihkarten()
    {
        setUpVerleihkarten();
    	assertTrue(_verleihService.getVerleihkarten().contains(_verleihkarte));
    }

    @Test
    public void testEntfernenVonVerleihkarten()
    {
    	setUpVerleihkarten();
    	List<Medium> _medien = new ArrayList<Medium>();
        _medien.add(_abbey);
    	_verleihService.nimmZurueck(_medien, Datum.heute() );
    	assertTrue(!_verleihService.getVerleihkarten().contains(_verleihkarte));
    }
    ...
    private void setUpVerleihkarten()
    {
    	
    	List<Medium> _medien = new ArrayList<Medium>();
        _medien.add(_abbey);
        _verleihkarte = new Verleihkarte(_homer,_abbey,Datum.heute());
